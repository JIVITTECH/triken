    ...
    (function (t) {
        ...
        (Wolmart.$window = t(window)),
            ...
            (Wolmart.minipopupOption = {
                ...
                space: 20,
                template:
                    '<div class="minipopup-box"><div class="product product-list-sm {{productClass}}"><figure class="product-media"><a href="{{imageLink}}"><img onerror="onError(this)" src="{{imageSrc}}" alt="Product" /></a></figure><div class="product-details"><h4 class="product-name"><a href="{{nameLink}}">{{name}}</a></h4>{{message}}</div></div><div class="product-action">{{actionTemplate}}</div></div>',
            }),
            (Wolmart.Minipopup =
                ((i = 0),
                (a = []),
                            ...
                            : (i.toggleClass("added").addClass("load-more-overlay loading"),
                              setTimeout(function () {
                                  ...
                                  if (document.getElementById("add_button") != null) {
                                      cus_message = (document.getElementById("add_button").style.display == "block")? "<p>has been removed from your cart:</p>" : "<p>has been added to your cart:</p>";
                                      product_name = a.find("#sel_name").text();
                                  } else {
                                      cus_message = "<p>has been added to your cart:</p>";
                                      product_name = a.find(".product-name, .product-title").text();
                                  }
                                  i.removeClass("load-more-overlay loading"),
                                      Wolmart.Minipopup.open({
                                          ...
                                          message: cus_message,
                                          actionTemplate: '<a onclick ="checkUserSession()"  class="btn btn-rounded btn-sm">View Cart</a><a onclick ="checkUserSession()"  class="btn btn-dark btn-rounded btn-sm">Checkout</a>',
                                      });
                              }, 500));
                    }),
        ...
        function n(e) {
            ...
            if (i.hasClass("disabled")) alert("Please select some product options before adding this product to your cart.");
                ...
                if (a.length)
                    ...
                    var message = (document.getElementById("add_button").style.display == "block")? "has been removed from your cart" : "has been added to your cart";
					var n =
                        '<div class="alert alert-success alert-cart-product container mb-2">                            <a onclick ="checkUserSession()"  class="btn btn-success btn-rounded">View Cart</a>                            <p class="mb-0 ls-normal">“' +
                        i.closest(".product-single").find(".sel_name").text() +
                        '” ' + message + '</p>                            <a href="#" class="btn btn-link btn-close" aria-label="button"><i class="close-icon"></i></a>                            </div>';
