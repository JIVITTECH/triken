			                    ...
			                    <div class="swiper-wrapper row cols-lg-1 cols-md-3">
				                        ...
				                        <div class="product">
											<figure class="product-media">
												...
												<div class="product-label-group">
				                                	<label class="product-label label-discount"> Best Seller </label>
												</div>
											</figure>
											<div class="product-details">
												<h3 class="single-product-name"> <a href="#">Indian Shad (Hilsa) / Oolum, Ooli</a> </h3>
												<div class="row prod_quant">
				                    ...
				                    <div class="swiper-slide product-widget-wrap">
				                        <div class="product">
											...
											<div class="product-details">
												<h3 class="single-product-name"> <a href="#">Country Chicken Wholebird with Skin</a> </h3>
												<div class="row prod_quant">
				                    ...
				                    <div class="swiper-slide product-widget-wrap">
				                        <div class="product">
											...
											<div class="product-details">
												<h3 class="single-product-name"> <a href="#">Country Egg pack of 30</a> </h3>
												<div class="row prod_quant">
													<div class="product-cat col-md-6">Net wt: 250 gms</div>
													<div class="product-cat col-md-6">Delivery: 120 mins</div>
												</div>
												<div class="row">
													<div class="col-md-8 product-price">
				                    ...
				                    <div class="swiper-slide product-widget-wrap">
				                        <div class="product">
											...
											<div class="product-details">
												<h3 class="single-product-name"> <a href="#">Catla / Kelluthi</a> </h3>
												<div class="row prod_quant">
													<div class="product-cat col-md-6">Net wt: 500 gms</div>
													<div class="product-cat col-md-6">Delivery: 120 mins</div>
												</div>
